...
for (j=0; j<=8; j++)
	{
		fscanf(data, "%f %f %f %f %f %lf %lf %lf", &te[j], &h[j], &x0[j], &y0[j], &z0[j], &vx0[j], &vy0[j], &vz0[j]);
	}
	fclose(data);
...
for (j=0; j<=a; j++)
	{
		...
		vx[0]=vx0[0]-((h[0]*G*x0[0])/pow(r[0],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[1]=vx0[1]-((h[1]*G*x0[1])/pow(r[1],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[2]=vx0[2]-((h[2]*G*x0[2])/pow(r[2],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[3]=vx0[3]-((h[3]*G*x0[3])/pow(r[3],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[4]=vx0[4]-((h[4]*G*x0[4])/pow(r[4],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[5]=vx0[5]-((h[5]*G*x0[5])/pow(r[5],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[6]=vx0[6]-((h[6]*G*x0[6])/pow(r[6],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[7]=vx0[7]-((h[7]*G*x0[7])/pow(r[7],3));
...
for (j=0; j<=a; j++)
	{
		...
		vx[8]=vx0[8]-((h[8]*G*x0[8])/pow(r[8],3));
